...
const DEFAULT_INNER_GRADIENT = "linear-gradient(145deg, #18120c 0%, #FB6C0044 100%)";
...
const ProfileCardComponent: React.FC<ProfileCardProps> = ({
  ...
  const cardStyle = useMemo(
    () => ({
      ...
      "--behind-glow-color": behindGlowColor ?? "rgba(251, 108, 0, 0.67)",
                ...
                <div className="pc-user-info">
                  <div className="pc-user-details">
                    ...
                    <div className="pc-user-text">
                      ...
                      <div className="pc-[#status] pc-status">{status}</div>
                    </div>
                  </div>
                  <button
