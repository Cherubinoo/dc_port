...
export default function Stepper({
  ...
  return (
    <div className={`outer-container ${className}`.trim()} style={style} {...rest}>
...
function StepIndicator({
  ...
  return (
    ...
    >
      <motion.div
        variants={{
          inactive: { scale: 1, backgroundColor: "#1e1b18", color: "#a3a3a3" },
          active: { scale: 1.1, backgroundColor: "#FB6C00", color: "#FFFFFF" },
          complete: { scale: 1, backgroundColor: "#FB6C00", color: "#FFFFFF" },
        }}
...
function StepConnector({ isComplete }: { isComplete: boolean }) {
  const lineVariants = {
    ...
    complete: { width: "100%", backgroundColor: "#FB6C00" },
  };
